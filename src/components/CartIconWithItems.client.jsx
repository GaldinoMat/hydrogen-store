  ...
  return (
    <>
      <div className="relative">
        ...
        <div
          className={`bg-blue-700 text-xs rounded-full leading-none text-white absolute bottom-1 right-3 flex items-center justify-center transform translate-y-1/2 transition-all ${
